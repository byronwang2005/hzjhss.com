...
// .wrangler/tmp/pages-JmaDmr/functionsWorker-0.22671640416101113.mjs
...
var DEFAULT_ROOT_PREFIX;
var DEFAULT_MAX_FILE_MB;
var DEFAULT_SIGN_EXPIRES_SECONDS;
var MAX_SIGN_EXPIRES_SECONDS;
...
var init_config = __esm({
  "../src/drive/config.ts"() {
    ...
    __name2(normalizeRootPrefix, "normalizeRootPrefix");
...
var init_http = __esm({
  "../src/drive/http.ts"() {
    ...
    __name2(requireDriveSession, "requireDriveSession");
...
var init_paths = __esm({
  "../src/drive/paths.ts"() {
    ...
    __name2(normalizePrefix, "normalizePrefix");
    __name2(normalizeFileName, "normalizeFileName");
    __name2(normalizeRelativeFilePath, "normalizeRelativeFilePath");
    __name2(normalizeFolderName, "normalizeFolderName");
    __name2(normalizeObjectPath, "normalizeObjectPath");
    __name2(makeObjectKey, "makeObjectKey");
    __name2(trimRootPrefix, "trimRootPrefix");
    __name2(normalizeRelativePath, "normalizeRelativePath");
...
var init_cos = __esm({
  "../src/drive/cos.ts"() {
    ...
    __name2(createFolder, "createFolder");
...
var DRIVE_META_FILENAME;
var TOPIC_META_FILENAME;
var GENERATE_PROMPT_FILENAME;
var OUTPUTS_FOLDER_NAME;
var AGENT_MANIFEST_FOLDER_NAME;
var init_topic = __esm({
  "../src/drive/topic.ts"() {
    ...
    __name2(topicPrefixFromName, "topicPrefixFromName");
    __name2(normalizeTopicPrefix, "normalizeTopicPrefix");
    __name2(isSystemFileName, "isSystemFileName");
    __name2(hasSystemPathSegment, "hasSystemPathSegment");
    __name2(createTopic, "createTopic");
    __name2(readTopic, "readTopic");
    __name2(updateTopic, "updateTopic");
    __name2(deleteTopic, "deleteTopic");
    __name2(listDirectoryWithMetadata, "listDirectoryWithMetadata");
    __name2(mergeListMetadata, "mergeListMetadata");
    __name2(recordUploadComplete, "recordUploadComplete");
    __name2(removeFileMetadata, "removeFileMetadata");
    __name2(createAgentManifest, "createAgentManifest");
    __name2(createAgentManifestPrompt, "createAgentManifestPrompt");
    __name2(listTopicMaterialFiles, "listTopicMaterialFiles");
    __name2(listAllDirectoryWithMetadata, "listAllDirectoryWithMetadata");
    __name2(listAllObjectPaths, "listAllObjectPaths");
    __name2(isAgentReadableFolder, "isAgentReadableFolder");
    __name2(isAgentReadableFile, "isAgentReadableFile");
    __name2(createDefaultPrompts, "createDefaultPrompts");
    __name2(ensureTopicScaffold, "ensureTopicScaffold");
    __name2(readTopicMetadataIfExists, "readTopicMetadataIfExists");
    __name2(topicNameFromPrefix, "topicNameFromPrefix");
    __name2(recordFileMetadata, "recordFileMetadata");
    __name2(readDriveMeta, "readDriveMeta");
    __name2(writeDriveMeta, "writeDriveMeta");
    __name2(fileMetadata, "fileMetadata");
    __name2(normalizeDescription, "normalizeDescription");
    ...
    __name2(normalizeUploadKind, "normalizeUploadKind");
    __name2(directoryPrefixFromPath, "directoryPrefixFromPath");
    __name2(fileNameFromPath, "fileNameFromPath");
    __name2(byteLength, "byteLength");
    __name2(compactTimestamp, "compactTimestamp");
    __name2(createNonce, "createNonce");
  }
});
var onRequestPost;
...
var init_logout = __esm({
  "api/drive/logout.ts"() {
    ...
    init_http();
    init_session();
    onRequestPost5 = /* @__PURE__ */ __name2(async ({ request }) => {
...
var init_object = __esm({
  "api/drive/object.ts"() {
    ...
    init_paths();
    init_topic();
    onRequestDelete = /* @__PURE__ */ __name2(async ({ request, env }) => {
      try {
        const unauthorized = await requireDriveSession({ request, env });
        if (unauthorized) {
          return unauthorized;
...
var init_topic2 = __esm({
  "api/drive/topic.ts"() {
    ...
    onRequestPut = /* @__PURE__ */ __name2(async ({ request, env }) => {
      try {
        const session = await readDriveSession({ request, env });
        if (session instanceof Response) {
          return session;
...
var init_upload_url = __esm({
  "api/drive/upload-url.ts"() {
    ...
    __name2(normalizeUploadPath, "normalizeUploadPath");
  }
});
var routes;
...
// .wrangler/tmp/bundle-AUHCJZ/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-AUHCJZ/middleware-loader.entry.ts
...
aws4fetch/dist/aws4fetch.esm.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.22671640416101113.js.map

...
import { onRequestGet as __api_drive_overview_ts_onRequestGet } from "/Users/macbook/git/hzjhss.com/functions/api/drive/overview.ts"
import { onRequestPost as __api_drive_process_retry_ts_onRequestPost } from "/Users/macbook/git/hzjhss.com/functions/api/drive/process-retry.ts"
import { onRequestPost as __api_drive_qa_ts_onRequestPost } from "/Users/macbook/git/hzjhss.com/functions/api/drive/qa.ts"
...
export const routes = [
    ...
    },
  {
      ...
      method: "GET",
      middlewares: [],
      modules: [__api_drive_overview_ts_onRequestGet],
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_drive_process_retry_ts_onRequestPost],
    },
  {
      ...
      method: "POST",
      middlewares: [],
      modules: [__api_drive_qa_ts_onRequestPost],
    },
  {

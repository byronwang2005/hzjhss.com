...
// .wrangler/tmp/pages-HRvY5c/functionsWorker-0.41340377353986224.mjs
...
var KNOWLEDGE_ROOT_PREFIX;
var SIGN_EXPIRES_SECONDS;
var DEFAULT_SESSION_MAX_AGE_SECONDS;
var DEFAULT_AI_MAX_OUTPUT_TOKENS;
var init_config = __esm({
  "../src/drive/config.ts"() {
    ...
    __name2(getRequiredEnv, "getRequiredEnv");
    __name2(getDriveConfig, "getDriveConfig");
    __name2(getAiConfig, "getAiConfig");
    __name2(normalizeAiBaseUrl, "normalizeAiBaseUrl");
    __name2(normalizeEndpoint, "normalizeEndpoint");
    __name2(parsePositiveInt, "parsePositiveInt");
  }
});
...
var COOKIE_NAME;
var CONTROL_CHARS;
var MAX_DISPLAY_NAME_LENGTH;
var DEFAULT_SESSION_MAX_AGE_SECONDS2;
var DRIVE_ADMIN_DISPLAY_NAME;
var init_session = __esm({
  "../src/drive/session.ts"() {
    ...
    __name2(isDriveAdmin, "isDriveAdmin");
    __name2(createSessionCookie, "createSessionCookie");
    __name2(getSessionMaxAgeSeconds, "getSessionMaxAgeSeconds");
    __name2(clearSessionCookie, "clearSessionCookie");
    __name2(getDriveSession, "getDriveSession");
    __name2(verifyAccessCode, "verifyAccessCode");
    __name2(normalizeDisplayName, "normalizeDisplayName");
    __name2(parseCookie, "parseCookie");
    __name2(sign, "sign");
    __name2(signWithPurpose, "signWithPurpose");
...
var init_http = __esm({
  "../src/drive/http.ts"() {
    ...
    __name2(readDriveSession, "readDriveSession");
    __name2(readDriveAdminSession, "readDriveAdminSession");
...
var CONTROL_CHARS2;
var MAX_SEGMENT_LENGTH;
var MAX_RELATIVE_PATH_LENGTH;
var PathValidationError;
var init_paths = __esm({
  "../src/drive/paths.ts"() {
    ...
    __name2(normalizeRelativeFilePath, "normalizeRelativeFilePath");
    __name2(makeObjectKey, "makeObjectKey");
    __name2(trimRootPrefix, "trimRootPrefix");
    __name2(normalizeStrictRelativeFilePath, "normalizeStrictRelativeFilePath");
    __name2(validateSegment, "validateSegment");
  }
});
...
var init_cos = __esm({
  "../src/drive/cos.ts"() {
    ...
    __name2(listObjects, "listObjects");
    __name2(listObjectPaths, "listObjectPaths");
    __name2(putObjectText, "putObjectText");
    __name2(getObjectText, "getObjectText");
    __name2(headObject, "headObject");
    __name2(deleteObject, "deleteObject");
    __name2(copyObject, "copyObject");
    __name2(deleteObjects, "deleteObjects");
    __name2(presignObjectUrl, "presignObjectUrl");
    __name2(parseListObjectsXml, "parseListObjectsXml");
    __name2(parseObjectPathsXml, "parseObjectPathsXml");
    __name2(isSystemFile, "isSystemFile");
    __name2(createClient, "createClient");
    __name2(signedFetch, "signedFetch");
    __name2(objectUrl, "objectUrl");
...
var MAX_PDF_PAGES;
var TOPIC_ID_PATTERN;
var IMAGE_EXTENSIONS;
var LARGE_DOCUMENT_EXTENSIONS;
var SMALL_DOCUMENT_EXTENSIONS;
var init_knowledge = __esm({
  "../src/drive/knowledge.ts"() {
    ...
    __name2(normalizeTopicId, "normalizeTopicId");
    __name2(normalizeTopicName, "normalizeTopicName");
    __name2(filePolicy, "filePolicy");
    __name2(topicPrefix, "topicPrefix");
    __name2(sourcePath, "sourcePath");
    __name2(fileMetaPath, "fileMetaPath");
    __name2(processedPrefix, "processedPrefix");
    __name2(tempUploadPath, "tempUploadPath");
    __name2(processingStatusPath, "processingStatusPath");
    __name2(topicIndexPath, "topicIndexPath");
    __name2(topicIndexManifestPath, "topicIndexManifestPath");
    __name2(createKnowledgeTopic, "createKnowledgeTopic");
    __name2(updateKnowledgeTopic, "updateKnowledgeTopic");
    __name2(readKnowledgeTopic, "readKnowledgeTopic");
    __name2(listKnowledgeTopics, "listKnowledgeTopics");
    __name2(deleteKnowledgeTopic, "deleteKnowledgeTopic");
    __name2(listKnowledgeFiles, "listKnowledgeFiles");
    __name2(createUpload, "createUpload");
    __name2(completeUpload, "completeUpload");
    __name2(deleteKnowledgeFile, "deleteKnowledgeFile");
    __name2(createDownloadUrl, "createDownloadUrl");
    __name2(readTopicSearchIndex, "readTopicSearchIndex");
    __name2(deletePrefix, "deletePrefix");
    __name2(createTopicId, "createTopicId");
    __name2(createUploadId, "createUploadId");
    __name2(normalizeUploadId, "normalizeUploadId");
    __name2(readJson, "readJson");
    __name2(normalizeDirectoryPrefix, "normalizeDirectoryPrefix");
    __name2(normalizePositiveSize, "normalizePositiveSize");
    __name2(normalizeContentType, "normalizeContentType");
    __name2(normalizePdfPages, "normalizePdfPages");
    __name2(baseContentType, "baseContentType");
    __name2(sizeLimitError, "sizeLimitError");
  }
});
var onRequestPost;
...
var init_users = __esm({
  "../src/drive/users.ts"() {
    ...
    __name2(registerDriveUser, "registerDriveUser");
    __name2(readDriveUserRegistry, "readDriveUserRegistry");
    __name2(writeDriveUserRegistry, "writeDriveUserRegistry");
  }
});
var onRequestPost2;
...
var init_logout = __esm({
  "api/drive/logout.ts"() {
    ...
    init_http();
    init_session();
    onRequestPost3 = /* @__PURE__ */ __name2(async ({ request }) => {
...
var init_webhooks = __esm({
  "../src/drive/webhooks.ts"() {
    "use strict";
    init_functionsRoutes_0_5642982318397151();
    __name2(notifyProcessor, "notifyProcessor");
    __name2(notifyIndexer, "notifyIndexer");
...
var init_object = __esm({
  "api/drive/object.ts"() {
    ...
    init_knowledge();
    init_webhooks();
    onRequestDelete = /* @__PURE__ */ __name2(async ({ request, env, waitUntil }) => {
      try {
        const session = await readDriveAdminSession({ request, env });
        if (session instanceof Response) return session;
        const body = await readJsonBody(request);
...
var init_process_retry = __esm({
  "api/drive/process-retry.ts"() {
    ...
    init_knowledge();
    init_webhooks();
    onRequestPost4 = /* @__PURE__ */ __name2(async ({ request, env, waitUntil }) => {
      try {
        const session = await readDriveAdminSession({ request, env });
        if (session instanceof Response) return session;
        const body = await readJsonBody(request);
...
var init_uuid = __esm({
  "../node_modules/openai/internal/utils/uuid.mjs"() {
    init_functionsRoutes_0_5642982318397151();
    uuid4 = /* @__PURE__ */ __name2(function() {
...
var InvalidWebhookSignatureError;
var OAuthError;
var SubjectTokenProviderError;
var init_error = __esm({
  "../node_modules/openai/core/error.mjs"() {
    ...
    InvalidWebhookSignatureError = class extends Error {
      ...
      static {
        __name2(this, "InvalidWebhookSignatureError");
      }
      constructor(message) {
        super(message);
      }
    ...
    SubjectTokenProviderError = class extends OpenAIError {
      ...
      static {
        __name2(this, "SubjectTokenProviderError");
      }
...
var init_values = __esm({
  "../node_modules/openai/internal/utils/values.mjs"() {
    ...
    isArray = /* @__PURE__ */ __name2((val) => (isArray = Array.isArray, isArray(val)), "isArray");
...
var init_formats = __esm({
  "../node_modules/openai/internal/qs/formats.mjs"() {
    ...
    default_formatter = /* @__PURE__ */ __name2((v) => String(v), "default_formatter");
    formatters = {
...
var init_utils = __esm({
  "../node_modules/openai/internal/qs/utils.mjs"() {
    ...
    init_formats();
    init_values();
    has = /* @__PURE__ */ __name2((obj, key) => (has = Object.hasOwn ?? Function.prototype.call.bind(Object.prototype.hasOwnProperty), has(obj, key)), "has");
    hex_table = /* @__PURE__ */ (() => {
      const array = [];
      for (let i = 0; i < 256; ++i) {
...
var init_pagination = __esm({
  "../node_modules/openai/core/pagination.mjs"() {
    ...
    ConversationCursorPage = class extends AbstractPage {
      ...
      static {
        __name2(this, "ConversationCursorPage");
      }
      constructor(client, response, body, options) {
        super(client, response, body, options);
        this.data = body.data || [];
...
var init_workload_identity_auth = __esm({
  "../node_modules/openai/auth/workload-identity-auth.mjs"() {
    ...
    WorkloadIdentityAuth = class {
      ...
      static {
        __name2(this, "WorkloadIdentityAuth");
      }
...
var isAsyncIterable;
var maybeMultipartFormRequestOptions;
var multipartFormRequestOptions;
var supportsFormDataMap;
var createForm;
var isNamedBlob;
var isUploadable;
var hasUploadableValue;
var addFormValue;
var init_uploads = __esm({
  "../node_modules/openai/internal/uploads.mjs"() {
    ...
    maybeMultipartFormRequestOptions = /* @__PURE__ */ __name2(async (opts, fetch2) => {
      if (!hasUploadableValue(opts.body))
        return opts;
      return { ...opts, body: await createForm(opts.body, fetch2) };
    }, "maybeMultipartFormRequestOptions");
    multipartFormRequestOptions = /* @__PURE__ */ __name2(async (opts, fetch2) => {
      return { ...opts, body: await createForm(opts.body, fetch2) };
    }, "multipartFormRequestOptions");
    supportsFormDataMap = /* @__PURE__ */ new WeakMap();
    __name2(supportsFormData, "supportsFormData");
    createForm = /* @__PURE__ */ __name2(async (body, fetch2) => {
    ...
    isNamedBlob = /* @__PURE__ */ __name2((value) => value instanceof Blob && "name" in value, "isNamedBlob");
    isUploadable = /* @__PURE__ */ __name2((value) => typeof value === "object" && value !== null && (value instanceof Response || isAsyncIterable(value) || isNamedBlob(value)), "isUploadable");
    hasUploadableValue = /* @__PURE__ */ __name2((value) => {
  ...
  "../node_modules/openai/lib/EventStream.mjs"() {
    ...
    EventStream = class {
      ...
      _listenForAbort(signal) {
        ...
        const listener = /* @__PURE__ */ __name2(() => this.controller.abort(), "listener");
    ...
    _EventStream_connectedPromise = /* @__PURE__ */ new WeakMap(), _EventStream_resolveConnectedPromise = /* @__PURE__ */ new WeakMap(), _EventStream_rejectConnectedPromise = /* @__PURE__ */ new WeakMap(), _EventStream_endPromise = /* @__PURE__ */ new WeakMap(), _EventStream_resolveEndPromise = /* @__PURE__ */ new WeakMap(), _EventStream_rejectEndPromise = /* @__PURE__ */ new WeakMap(), _EventStream_listeners = /* @__PURE__ */ new WeakMap(), _EventStream_abortListeners = /* @__PURE__ */ new WeakMap(), _EventStream_ended = /* @__PURE__ */ new WeakMap(), _EventStream_errored = /* @__PURE__ */ new WeakMap(), _EventStream_aborted = /* @__PURE__ */ new WeakMap(), _EventStream_catchingPromiseCreated = /* @__PURE__ */ new WeakMap(), _EventStream_instances = /* @__PURE__ */ new WeakSet(), _EventStream_removeAbortListeners = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _EventStream_removeAbortListeners2() {
      for (const { signal, listener } of __classPrivateFieldGet(this, _EventStream_abortListeners, "f").splice(0)) {
        signal.removeEventListener("abort", listener);
      }
    }, "_EventStream_removeAbortListeners2"), "_EventStream_removeAbortListeners"), _EventStream_handleError = /* @__PURE__ */ __name2(/* @__PURE__ */ __name(function _EventStream_handleError2(error) {
...
var init_AbstractChatCompletionRunner = __esm({
  "../node_modules/openai/lib/AbstractChatCompletionRunner.mjs"() {
    ...
    __name2(normalizeToolCallIds, "normalizeToolCallIds");
    AbstractChatCompletionRunner = class extends EventStream {
      ...
      async _runTools(client, params, runner, options) {
        ...
        const runToolCall = /* @__PURE__ */ __name2(async (toolCall) => {
          if (toolCall.type !== "function")
...
var init_hosted_tool_permissions = __esm({
  "../node_modules/openai/resources/admin/organization/projects/hosted-tool-permissions.mjs"() {
    ...
    HostedToolPermissions = class extends APIResource {
      ...
      static {
        __name2(this, "HostedToolPermissions");
      }
      /**
...
var init_ResponsesParser = __esm({
  "../node_modules/openai/lib/ResponsesParser.mjs"() {
    ...
    __name2(needsOutputText, "needsOutputText");
...
var init_ResponseStream = __esm({
  "../node_modules/openai/lib/responses/ResponseStream.mjs"() {
    ...
    ResponseStream = class _ResponseStream extends EventStream {
      ...
      }, "_ResponseStream_endRequest2"), "_ResponseStream_endRequest"), Symbol.asyncIterator)]() {
        const pushQueue = [];
        const readQueue = [];
        let done = false;
        this.on("event", (event) => {
...
var providerDefinitionsKey;
var providerGlobal;
var existingProviderDefinitions;
...
var init_provider = __esm({
  "../node_modules/openai/internal/provider.mjs"() {
    ...
    __name2(configureProvider, "configureProvider");
  }
});
...
var WORKLOAD_IDENTITY_API_KEY_PLACEHOLDER;
var OpenAI;
var init_client = __esm({
  "../node_modules/openai/client.mjs"() {
    ...
    __name2(getConnectionErrorMessage, "getConnectionErrorMessage");
    __name2(isUndiciDispatcherVersionMismatchError, "isUndiciDispatcherVersionMismatchError");
  }
});
...
var MAX_HISTORY_ROUNDS;
var MAX_QUESTION_LENGTH;
var MAX_ASSISTANT_MESSAGE_LENGTH;
var init_qa = __esm({
  "../src/drive/qa.ts"() {
    "use strict";
    init_functionsRoutes_0_5642982318397151();
    ...
    __name2(normalizeQaMessages, "normalizeQaMessages");
    __name2(createRetrievedQaSystemMessage, "createRetrievedQaSystemMessage");
    __name2(createQaClient, "createQaClient");
    __name2(upstreamAiErrorMessage, "upstreamAiErrorMessage");
    __name2(upstreamAiHttpStatus, "upstreamAiHttpStatus");
    __name2(encodeSse, "encodeSse");
  }
});
var ENTRIES;
var KEYS;
...
var assignUniqueTerm;
var assignUniqueTerms;
var byScore;
var createMap;
var objectToNumericMap;
var objectToNumericMapAsync;
var wait;
...
var init_es = __esm({
  "../node_modules/minisearch/dist/es/index.js"() {
    ...
    last$1 = /* @__PURE__ */ __name2((array) => {
      return array[array.length - 1];
    }, "last$1");
    fuzzySearch = /* @__PURE__ */ __name2((node, query, maxDistance) => {
    ...
    recurse = /* @__PURE__ */ __name2((node, query, maxDistance, results, matrix, m, n, prefix) => {
      const offset = m * n;
    ...
    SearchableMap = class _SearchableMap {
      static {
        __name(this, "_SearchableMap");
      }
      static {
        __name2(this, "SearchableMap");
      }
      /**
    ...
    trackDown = /* @__PURE__ */ __name2((tree, key, path2 = []) => {
    ...
    lookup = /* @__PURE__ */ __name2((tree, key) => {
      if (key.length === 0 || tree == null) {
        return tree;
      }
      for (const k of tree.keys()) {
    ...
    createPath = /* @__PURE__ */ __name2((node, key) => {
    ...
    remove = /* @__PURE__ */ __name2((tree, key) => {
    ...
    cleanup = /* @__PURE__ */ __name2((path2) => {
      if (path2.length === 0) {
        return;
      }
    ...
    merge = /* @__PURE__ */ __name2((path2, key, value) => {
      if (path2.length === 0) {
        return;
      }
    ...
    MiniSearch = class _MiniSearch {
      static {
        __name(this, "_MiniSearch");
      }
      static {
        __name2(this, "MiniSearch");
      }
      /**
    ...
    getOwnProperty = /* @__PURE__ */ __name2((object, property) => Object.prototype.hasOwnProperty.call(object, property) ? object[property] : void 0, "getOwnProperty");
    combinators = {
      [OR]: (a, b) => {
    ...
    calcBM25Score = /* @__PURE__ */ __name2((termFreq, matchingCount, totalCount, fieldLength, avgFieldLength, bm25params) => {
      const { k, b, d } = bm25params;
      const invDocFreq = Math.log(1 + (totalCount - matchingCount + 0.5) / (matchingCount + 0.5));
      return invDocFreq * (d + termFreq * (k + 1) / (termFreq + k * (1 - b + b * fieldLength / avgFieldLength)));
    }, "calcBM25Score");
    termToQuerySpec = /* @__PURE__ */ __name2((options) => (term, i, terms) => {
    ...
    defaultOptions = {
      idField: "id",
      extractField: /* @__PURE__ */ __name2((document, fieldName) => document[fieldName], "extractField"),
      stringifyField: /* @__PURE__ */ __name2((fieldValue, fieldName) => fieldValue.toString(), "stringifyField"),
      tokenize: /* @__PURE__ */ __name2((text) => text.split(SPACE_OR_PUNCTUATION), "tokenize"),
      processTerm: /* @__PURE__ */ __name2((term) => term.toLowerCase(), "processTerm"),
      fields: void 0,
      searchOptions: void 0,
      storeFields: [],
      logger: /* @__PURE__ */ __name2((level, message) => {
    ...
    defaultAutoSuggestOptions = {
      combineWith: AND,
      prefix: /* @__PURE__ */ __name2((term, i, terms) => i === terms.length - 1, "prefix")
    };
    ...
    assignUniqueTerm = /* @__PURE__ */ __name2((target, term) => {
      if (!target.includes(term))
        target.push(term);
    }, "assignUniqueTerm");
    assignUniqueTerms = /* @__PURE__ */ __name2((target, source) => {
      for (const term of source) {
        if (!target.includes(term))
          target.push(term);
      }
    }, "assignUniqueTerms");
    byScore = /* @__PURE__ */ __name2(({ score: a }, { score: b }) => b - a, "byScore");
    createMap = /* @__PURE__ */ __name2(() => /* @__PURE__ */ new Map(), "createMap");
    objectToNumericMap = /* @__PURE__ */ __name2((object) => {
    ...
    objectToNumericMapAsync = /* @__PURE__ */ __name2(async (object) => {
      const map = /* @__PURE__ */ new Map();
      let count = 0;
      for (const key of Object.keys(object)) {
        map.set(parseInt(key, 10), object[key]);
    ...
    wait = /* @__PURE__ */ __name2((ms) => new Promise((resolve) => setTimeout(resolve, ms)), "wait");
...
function miniSearchOptions() {
  return {
    ...
    processTerm: /* @__PURE__ */ __name2((term) => term, "processTerm"),
    idField: "id"
  };
}
...
function searchSerializedIndex(envelope, query, limit2 = 8) {
  ...
  return search.search(query, {
    prefix: /* @__PURE__ */ __name2((term) => term.length >= 3, "prefix"),
    fuzzy: /* @__PURE__ */ __name2((term) => term.length >= 5 ? 0.1 : false, "fuzzy"),
...
var init_search = __esm({
  "../src/drive/search.ts"() {
    ...
    __name2(tokenizeKnowledgeText, "tokenizeKnowledgeText");
    __name2(miniSearchOptions, "miniSearchOptions");
    __name2(searchSerializedIndex, "searchSerializedIndex");
  }
});
...
var init_retrieval = __esm({
  "../src/drive/retrieval.ts"() {
    ...
    __name2(retrieveKnowledge, "retrieveKnowledge");
    __name2(loadIndex, "loadIndex");
  }
});
function sseHeaders() {
...
var init_topic = __esm({
  "api/drive/topic.ts"() {
    ...
    onRequestPost6 = /* @__PURE__ */ __name2(async ({ request, env }) => {
      try {
        const session = await readDriveAdminSession({ request, env });
        if (session instanceof Response) return session;
        const body = await readJsonBody(request);
    ...
    onRequestPut = /* @__PURE__ */ __name2(async ({ request, env, waitUntil }) => {
      try {
        const session = await readDriveAdminSession({ request, env });
        if (session instanceof Response) return session;
        const body = await readJsonBody(request);
    ...
    onRequestDelete2 = /* @__PURE__ */ __name2(async ({ request, env }) => {
      try {
        const session = await readDriveAdminSession({ request, env });
        if (session instanceof Response) return session;
        const body = await readJsonBody(request);
...
var cloneResponse2 = /* @__PURE__ */ __name2((response) => (
...
// .wrangler/tmp/bundle-bCj7rW/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-bCj7rW/middleware-loader.entry.ts
...
aws4fetch/dist/aws4fetch.esm.mjs:
   ...
   *)
*/
//# sourceMappingURL=functionsWorker-0.41340377353986224.js.map
